...
본 문서는 [2023년 국립국어원 인공 지능 언어 능력 평가: 감성 분석 과제](https://corpus.korean.go.kr/taskOrdtm/taskList.do?taskOrdtmId=103&clCd=END_TASK&subMenuId=sub01)에서 **은상**을 수상한 "사과는맛있어맛있으면바나나"팀의 모델 제작법에 관해 서술합니다.
